...
/**
 * A Mine class that allows you to display a textual value on screen.
 * 
 * The Mine is an actor, so you will need to create it, and then add it to the world
 * in Greenfoot.  If you keep a reference to the Mine then you can change the text it
 * displays.  
 *
...
public class Mine extends Actor
{
     ...
     */
    public Mine(int value, int fontSize)
    {
     ...
     */
    public Mine(String value, int fontSize)
    {
        this.value = value;
